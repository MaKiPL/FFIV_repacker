...
unsigned char * _LZ77(unsigned char * buffer, int buffsize)
{
return LZS_Encode(buffer, LZS_VRAM, buffsize);
}
...
/*----------------------------------------------------------------------------*/
unsigned char * LZS_Encode(unsigned char *buffer, int mode, int raw_len1) {
